...
- Juridiske, skatte-, moms-, CVR-, bank-, investeringsregel- og bogføringsmæssige påstande skal som udgangspunkt bygge på primære officielle kilder: SKAT/Skattestyrelsen, Den juridiske vejledning, Erhvervsstyrelsen, Virk, Digitaliseringsstyrelsen/NemKonto, Finanstilsynet, Retsinformation, Datatilsynet eller Virksomhedsguiden.
- Blogs, regnskabsprogrammer, banker, investeringsudbydere og andre kommercielle sider må bruges til at opdage spørgsmål, men ikke som autoritativt facit for en generel regel.
