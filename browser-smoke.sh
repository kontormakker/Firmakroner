...
dump skal-jeg-have-lei-kode.html /tmp/lei.html; grep -q 'Ja — juridisk person, der vil handle, skal have LEI' /tmp/lei.html; grep -q 'Ingen bagatelgrænse' /tmp/lei.html; grep -q 'Finanstilsynet' /tmp/lei.html; grep -q 'derivater' /tmp/lei.html; ! grep -q 'partner-ads.com' /tmp/lei.html
