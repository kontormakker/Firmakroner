...
dump '' /tmp/portal.html; grep -q 'Små virksomhedstal i almindelige kroner' /tmp/portal.html; grep -q '18 gratis værktøjer' /tmp/portal.html; grep -q 'google-site-verification' /tmp/portal.html
for href in firmakoeb.html momsregistrering-under-50000.html faktura-buffer.html udgifter-foer-opstart.html koersel-privat-bil.html telefon-internet.html reklame-eller-repraesentation.html hjemmekontor-fradrag.html kursus-eller-uddannelse-fradrag.html arbejstoej-fradrag.html arbejdstoej-fradrag.html software-fra-udlandet-moms.html faktura-krav-tjek.html skal-jeg-bogfoere-digitalt-2026.html hobby-eller-erhverv.html pmv-eller-enkeltmandsvirksomhed.html skjul-hjemmeadresse-cvr.html skal-jeg-have-erhvervskonto.html skal-jeg-have-lei-kode.html satser-2026.html; do grep -q "$href" /tmp/portal.html; done
...
dump skal-jeg-have-lei-kode.html /tmp/lei.html; grep -q 'Ja — juridisk person, der vil handle, skal have LEI' /tmp/lei.html; grep -q 'Ingen bagatelgrænse' /tmp/lei.html; grep -q 'Finanstilsynet' /tmp/lei.html; grep -q 'derivater' /tmp/lei.html; grep -q 'Reklame · reklamelink for LEI Service DK' /tmp/lei.html; grep -q 'partnerid=57323' /tmp/lei.html; grep -q 'bannerid=85033' /tmp/lei.html; grep -q 'leiPartnerConsent' /tmp/lei.html
...
dump affiliate.html /tmp/affiliate.html; grep -q 'aktive affiliate-samarbejder' /tmp/affiliate.html; grep -q 'Dinero' /tmp/affiliate.html; grep -q 'LEI Service DK' /tmp/affiliate.html; grep -q 'Beregninger påvirkes aldrig' /tmp/affiliate.html
dump privatliv.html /tmp/privacy.html; grep -q 'Partner-Ads' /tmp/privacy.html; grep -q 'Dinero' /tmp/privacy.html; grep -q 'LEI Service DK' /tmp/privacy.html; grep -q 'trackingpixels' /tmp/privacy.html

for page in portal: purchase:firmakoeb.html vat:momsregistrering-under-50000.html buffer:faktura-buffer.html startup:udgifter-foer-opstart.html mileage:koersel-privat-bil.html phone:telefon-internet.html representation:reklame-eller-repraesentation.html homeoffice:hjemmekontor-fradrag.html course:kursus-eller-uddannelse-fradrag.html workwear:arbejdstoej-fradrag.html software:software-fra-udlandet-moms.html invoice:faktura-krav-tjek.html digital:skal-jeg-bogfoere-digitalt-2026.html hobby:hobby-eller-erhverv.html pmv:pmv-eller-enkeltmandsvirksomhed.html cvr:skjul-hjemmeadresse-cvr.html bank:skal-jeg-have-erhvervskonto.html lei:skal-jeg-have-lei-kode.html rates:satser-2026.html; do
