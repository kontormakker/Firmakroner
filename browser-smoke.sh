...
dump '' /tmp/portal.html; grep -q 'Små virksomhedstal i almindelige kroner' /tmp/portal.html; grep -q '16 gratis værktøjer' /tmp/portal.html; grep -q 'google-site-verification' /tmp/portal.html
for href in firmakoeb.html momsregistrering-under-50000.html faktura-buffer.html udgifter-foer-opstart.html koersel-privat-bil.html telefon-internet.html reklame-eller-repraesentation.html hjemmekontor-fradrag.html kursus-eller-uddannelse-fradrag.html arbejdstoej-fradrag.html software-fra-udlandet-moms.html faktura-krav-tjek.html skal-jeg-bogfoere-digitalt-2026.html hobby-eller-erhverv.html pmv-eller-enkeltmandsvirksomhed.html skjul-hjemmeadresse-cvr.html satser-2026.html; do grep -q "$href" /tmp/portal.html; done
...
dump 'firmakoeb.html?p=10000&v=25&vr=1&vd=100&td=75&tr=40&t=asset&d=25' /tmp/legacy.html; grep -q 'Skatteestimat sat på pause' /tmp/legacy.html
...
dump skal-jeg-bogfoere-digitalt-2026.html /tmp/digital.html; grep -q 'Ja — omsætningsreglen rammer dig i 2026' /tmp/digital.html; grep -q '350.000 kr.' /tmp/digital.html; grep -q '400.000 kr.' /tmp/digital.html; grep -q 'over 300.000 kr.' /tmp/digital.html; grep -q 'Erhvervsstyrelsens fortegnelse' /tmp/digital.html; ! grep -q 'partner-ads.com' /tmp/digital.html
